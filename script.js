...
const characters = {
    ...
    trendhunter: {
        ...
        description: "Her viral dansı, her memeyi ilk senin akışında görüyoruz. Algoritman sana popüler kültürün nabzını tutturuyor."
    },
    techgeek: {
    ...
    traveler: {
        title: "Gezgin Ruh",
        description: "Akışın cennet gibi plajlar, egzotik şehirler ve seyahat ipuçlarıyla dolu. Algoritma seni sürekli yeni yerlere çağırıyor."
    },
    fashionista: {
        title: "Stil İkonu",
        description: "Kombinler, moda haftaları, markaların yeni koleksiyonları. Algoritman seni catwalk'tan hiç indirmiyor."
    },
    scholar: {
        title: "Bilgi Avcısı",
...
const questions = [
    ...
    },
    {
        ...
        answers: [
            { text: "Komik videolar ve memeler", type: "trendhunter", weight: 4 },
    ...
    {
        text: "Algoritmana göre idealin tatil nerede geçerdin?",
        answers: [
